...
func autoConvert_v1_AzureKeyVaultVolumeSource_To_api_AzureKeyVaultVolumeSource(in *v1.AzureKeyVaultVolumeSource, out *api.AzureKeyVaultVolumeSource, s conversion.Scope) error {
...
// Convert_v1_AzureKeyVaultVolumeSource_To_api_AzureKeyVaultVolumeSource is an autogenerated conversion function.
func Convert_v1_AzureKeyVaultVolumeSource_To_api_AzureKeyVaultVolumeSource(in *v1.AzureKeyVaultVolumeSource, out *api.AzureKeyVaultVolumeSource, s conversion.Scope) error {
	return autoConvert_v1_AzureKeyVaultVolumeSource_To_api_AzureKeyVaultVolumeSource(in, out, s)
}

func autoConvert_api_AzureKeyVaultVolumeSource_To_v1_AzureKeyVaultVolumeSource(in *api.AzureKeyVaultVolumeSource, out *v1.AzureKeyVaultVolumeSource, s conversion.Scope) error {
	out.VaultName = in.VaultName
	out.ObjectName = in.ObjectName
	out.ObjectKind = v1.AzureKeyVaultKind(in.ObjectKind)
	out.ObjectVersion = in.ObjectVersion
	return nil
}

// Convert_api_AzureKeyVaultVolumeSource_To_v1_AzureKeyVaultVolumeSource is an autogenerated conversion function.
func Convert_api_AzureKeyVaultVolumeSource_To_v1_AzureKeyVaultVolumeSource(in *api.AzureKeyVaultVolumeSource, out *v1.AzureKeyVaultVolumeSource, s conversion.Scope) error {
...
func autoConvert_api_VolumeSource_To_v1_VolumeSource(in *api.VolumeSource, out *v1.VolumeSource, s conversion.Scope) error {
	...
	out.AzureKeyVault = (*v1.AzureKeyVaultVolumeSource)(unsafe.Pointer(in.AzureKeyVault))
	return nil
}
